...
import { getAllianceName, getCharacterName, getCorporationName, isFriendlyKill, isWormholeRegion } from "../utils/utils"
...
export async function parseKill(event: { data: any, type: string }) {
    ...
    console.log(isWormholeRegion(killData).toString() + ' ' + killData.solar_system_id)
